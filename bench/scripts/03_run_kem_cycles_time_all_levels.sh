...
CSV_OUT="$PERF_DIR/lore_shake_kem_cycles_time_all_levels.csv"
echo "scheme,level,paper_name,classical_security,operation,iterations,warmup,avg_cycles,median_cycles,avg_us,median_us,pk_bytes,ct_bytes,sk_bytes,kappa,n,k,t,pure_shake,opt_status,failures" > "$CSV_OUT"

SRC_FILES="kem.c pke.c indcpa.c polyvec.c poly.c ntt.c sampler.c reduce.c symmetric-shake.c fips202.c toomcook.c verify.c bch_codec.c randombytes.c auxfunc.c KEM_AlgorithmInstance.c drng.c"
...
cp "$CSV_OUT" "$LORE_FORMAL_REPO/report/performance/lore_shake_kem_cycles_time_all_levels.csv"
